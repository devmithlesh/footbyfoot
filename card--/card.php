      ...
      >
        ...
        >
          <div class="mith-nav">
            <a
              href="../index.php"
              class="xl:mr-10 md:mr-10 py-10  cursor-pointer active:text-blue-500 text-gray-500 hover:text-gray-900"
              >Home</a
            >
            <a
              href="../men.php"
              class="mr-10 hover:text-gray-900 cursor-pointer mrgn-top-btm active:text-blue-500 text-gray-500"
              >Men</a
            >
            <a
              href="../women.php"
            ...
            <a
              href="./offer.php"
              class="mr-10 active:text-blue-500 cursor-pointer mrgn-top-btm text-gray-500 hover:text-gray-900"
              >Offers</a
            >
            <a
      ...
      <div class="container mx-auto w-full flex justify-between py-10 flex-col md:flex-row xl:flex-row">
        <div class="w-full md:w-5/12 xl:w-5/12 px-4 ">
          ...
          <div class="py-10">
            ...
            >
            <a href="../signup/login.php"  class="py-4 md:px-12 xl:px-12 px-6 bg-orange-400 hover:bg-orange-300 text-xs md:text-sm"><i class="fa-solid fa-bolt-lightning"></i> BUY NOW</a>
          </div>
        </div>
        <div class="w-full md:w-7/12 xl:w-7/12 md:ml-10 xl:ml-10 px-4">
          ...
          <span class="cursar-ponter py-1 px-2 bg-green-500 rounded-xl text-sm"
            >4.5 <i class="fa-solid fa-star"></i></span
