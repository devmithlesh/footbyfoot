   ...
   <!-- -------------------------------------------
    ...
    <div
            ...
            <nav class="flex flex-wrap items-center text-sm hidden xl:block md:block nav-bar-css" id="menu">
                <div class="mith-nav">
                    <a href="../user_index.php" class="xl:mr-10 md:mr-10 py-10 cursor-pointer text-gray-500  hover:text-gray-900">Home</a>
                    <a href="../men.php"
                        class="mr-10 hover:text-gray-900 cursor-pointer mrgn-top-btm active:text-blue-500 text-gray-500">Men</a>
                    <a href="../women.php" class="mr-10 hover:text-gray-900 cursor-pointer mrgn-top-btm text-gray-500">Women</a>
                    <a href="../offer-section/offer.php"
                        class="mr-10 cursor-pointer hover:text-gray-900 mrgn-top-btm active:text-blue-500 text-gray-500">Offers</a>
      ...
      <div class=" mx-auto container w-full md:w-7/12 xl:7/12 px-6">
        <div class=" py-10 font-bold overflow-hidden text-xs md:text-sm xl:text-sm">
            ...
            <div class="payment-method">
              ...
              <button class="mt-5 py-2 bg-blue-500 w-full text-gray-100 hover:bg-blue-400 text-sm font-bold">
                <a href="../orderhistory/history.php ">Pay Now</a></button>
            </div>
        </div>
    </section>
      <!-- footer start -->
