    ...
    <header class="text-gray-600">
        <div
            ...
            <a class="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0">
                <img src="../logo.png" alt="" class="xl:w-16 md:w-16 w-10" />
            ...
            <div href="#" class="border border-blue-500 flex items-center justify-between px-4 py-1 rounded-xl">
                <input type="text" placeholder="Search Items"
                    class="border-0 outline-0 text-sm text-gray-500 font-light" />
            ...
            <nav class="flex flex-wrap items-center text-sm hidden xl:block md:block nav-bar-css" id="menu">
                <div class="mith-nav">
                    <a href="../index.php" class="xl:mr-10 md:mr-10 py-10  cursor-pointer">Home</a>
                    ...
                    <a href="./offer.php" class="mr-10 text-blue-500 cursor-pointer mrgn-top-btm">Offers</a>
