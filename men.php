      ...
      >
        ...
        >
          <div class="mith-nav">
            <a
              href="./index.php"
              class="xl:mr-10 md:mr-10 py-10 hover:text-gray-900 cursor-pointer"
              >Home</a
            >
            <a
              href="./men.php"
              class="mr-10 text-blue-500 cursor-pointer mrgn-top-btm"
              >Men</a
            >
            <a
              href="./women.php"
              class="mr-10 hover:text-gray-900 cursor-pointer mrgn-top-btm active:text-blue-500"
              >Women</a
            >
            <a
        ...
        <div class="w-9/12 container mx-auto grid xl:grid-cols-3 md:grid-cols-3 grid-cols-1 gap-4">
          <div class="w-full border border-blue-100 hover:border-blue-500">
            ...
            <div>
              ...
              <p class="text-xs"><i class="fa-solid fa-location-dot text-blue-500"></i> Ramamandi Jalandhar, Punjab 144001</p>
            </div>
